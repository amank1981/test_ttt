...
<div class="body">
    ...
    <div class="dialog">
        <table>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:message code="player.userName.label" default="User Name"/></td>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:message code="player.age.label" default="Age"/></td>

                <td valign="top" class="value">${fieldValue(bean: playerInstance, field: "age")}</td>
